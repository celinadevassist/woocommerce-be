...
export class UpdateUserDTO {
  ...
  @ApiProperty({ description: 'Membership end date', type: Date, required: false })
  membershipEndDate?: Date;

  @ApiProperty({ description: 'Membership price paid', type: Number, required: false })
  membershipPrice?: number;

  @ApiProperty({ description: 'Number of specialist sessions attended', type: Number, required: false })
