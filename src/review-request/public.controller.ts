...
export class PublicReviewRequestController {
  ...
  @ApiResponse({ status: 200, description: 'Returns review request details for submission' })
  ...
  @ApiResponse({ status: 400, description: 'Token expired or reviews already submitted' })
