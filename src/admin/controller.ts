...
export class AdminController {
  ...
  async updateSubscription(
    ...
    return await this.adminService.updateSubscription(
      id,
      data,
      admin._id.toString(),
    );
  ...
  async cancelSubscription(
    ...
    return await this.adminService.cancelSubscription(
      storeId,
      data,
      admin._id.toString(),
    );
  ...
  async reactivateSubscription(
    ...
    return await this.adminService.reactivateSubscription(
      storeId,
      admin._id.toString(),
    );
  }
  ...
  async createSubscription(
    ...
    return await this.adminService.createSubscriptionForStore(
      storeId,
      data,
      admin._id.toString(),
    );
  ...
  async markInvoicePaid(
    ...
    return await this.adminService.markInvoicePaid(
      id,
      data,
      admin._id.toString(),
    );
  ...
  async cancelInvoice(
    ...
    return await this.adminService.cancelInvoice(
      id,
      data,
      admin._id.toString(),
    );
  ...
  async generateInvoice(
    ...
    return await this.adminService.generateInvoice(
      storeId,
      data,
      admin._id.toString(),
    );
