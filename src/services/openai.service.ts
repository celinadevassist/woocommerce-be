          ...
          messages: [
            {
              role: 'system',
              content:
                'You are a professional copywriter creating a detailed landing page for a any type of business giving to you',
            },
      ...
      if (result.success) {
        ...
        try {
          ...
          const landingPageValidation =
            LandingPageSchema.safeParse(landingPage);
          ...
          console.warn(
            'Content is not valid JSON. Returning as plain text:',
            content,
          );
